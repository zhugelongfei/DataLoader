...
namespace ThriftStruct
{
  ...
  public partial class ActivityLevel : TBase
  {
    ...
    private List<TestStruct> _VActivityRightDesc;
    ...
    public List<TestStruct> VActivityRightDesc
    {
      get
      {
          ...
          switch (field.ID)
          {
            ...
            case 6:
              if (field.Type == TType.List) {
                {
                  VActivityRightDesc = new List<TestStruct>();
      ...
      try
      {
        ...
        if (VActivityRightDesc != null && __isset.VActivityRightDesc) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TestStruct _iter3 in VActivityRightDesc)
            {
              _iter3.Write(oprot);
            }
            oprot.WriteListEnd();
