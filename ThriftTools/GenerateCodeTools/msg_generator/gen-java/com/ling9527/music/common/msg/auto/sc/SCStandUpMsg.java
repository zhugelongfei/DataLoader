...
public class SCStandUpMsg implements org.apache.thrift.TBase<SCStandUpMsg, SCStandUpMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCStandUpMsg");
  ...
  private static final org.apache.thrift.protocol.TField SEAT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("seatId", org.apache.thrift.protocol.TType.I16, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new SCStandUpMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCStandUpMsgTupleSchemeFactory());
  }
  ...
  private static final int __SEATID_ISSET_ID = 1;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCStandUpMsg.class, metaDataMap);
  }
   ...
   */
  public SCStandUpMsg(SCStandUpMsg other) {
    __isset_bitfield = other.__isset_bitfield;
    this.charId = other.charId;
    this.seatId = other.seatId;
  }

  public SCStandUpMsg deepCopy() {
    return new SCStandUpMsg(this);
  }
  ...
  public SCStandUpMsg setCharId(long charId) {
    this.charId = charId;
    setCharIdIsSet(true);
    return this;
  }
  ...
  public SCStandUpMsg setSeatId(short seatId) {
    this.seatId = seatId;
    setSeatIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCStandUpMsg)
      return this.equals((SCStandUpMsg)that);
    return false;
  }

  public boolean equals(SCStandUpMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCStandUpMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCStandUpMsg typedOther = (SCStandUpMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCStandUpMsg(");
    boolean first = true;
  ...
  private static class SCStandUpMsgStandardSchemeFactory implements SchemeFactory {
    public SCStandUpMsgStandardScheme getScheme() {
      return new SCStandUpMsgStandardScheme();
    }
  }

  private static class SCStandUpMsgStandardScheme extends StandardScheme<SCStandUpMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCStandUpMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCStandUpMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCStandUpMsgTupleSchemeFactory implements SchemeFactory {
    public SCStandUpMsgTupleScheme getScheme() {
      return new SCStandUpMsgTupleScheme();
    }
  }

  private static class SCStandUpMsgTupleScheme extends TupleScheme<SCStandUpMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCStandUpMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCStandUpMsg struct) throws org.apache.thrift.TException {
