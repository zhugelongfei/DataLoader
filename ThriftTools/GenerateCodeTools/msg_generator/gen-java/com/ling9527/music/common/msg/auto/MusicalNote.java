...
public class MusicalNote implements org.apache.thrift.TBase<MusicalNote, MusicalNote._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MusicalNote");
  ...
  private static final org.apache.thrift.protocol.TField CONTINUE_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("continueCount", org.apache.thrift.protocol.TType.BYTE, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new MusicalNoteStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MusicalNoteTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    INDEX((short)1, "index"),
    TYPE((short)2, "type"),
    CONTINUE_COUNT((short)3, "continueCount");
  ...
  private static final int __CONTINUECOUNT_ISSET_ID = 2;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MusicalNote.class, metaDataMap);
  }
  ...
  public MusicalNote setIndex(byte index) {
    this.index = index;
    setIndexIsSet(true);
    return this;
  }
  ...
  public MusicalNote setType(byte type) {
    this.type = type;
    setTypeIsSet(true);
    return this;
  }
  ...
  public MusicalNote setContinueCount(byte continueCount) {
    this.continueCount = continueCount;
    setContinueCountIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MusicalNote)
      return this.equals((MusicalNote)that);
    return false;
  }

  public boolean equals(MusicalNote that) {
    if (that == null)
      return false;
  ...
  public int compareTo(MusicalNote other) {
    ...
    MusicalNote typedOther = (MusicalNote)other;
  ...
  private static class MusicalNoteStandardSchemeFactory implements SchemeFactory {
    public MusicalNoteStandardScheme getScheme() {
      return new MusicalNoteStandardScheme();
    }
  }

  private static class MusicalNoteStandardScheme extends StandardScheme<MusicalNote> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MusicalNote struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MusicalNote struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MusicalNoteTupleSchemeFactory implements SchemeFactory {
    public MusicalNoteTupleScheme getScheme() {
      return new MusicalNoteTupleScheme();
    }
  }

  private static class MusicalNoteTupleScheme extends TupleScheme<MusicalNote> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MusicalNote struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MusicalNote struct) throws org.apache.thrift.TException {
