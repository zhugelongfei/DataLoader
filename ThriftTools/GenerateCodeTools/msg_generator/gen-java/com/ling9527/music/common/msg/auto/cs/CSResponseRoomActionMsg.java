 ...
 * 响应做动作请求
 */
public class CSResponseRoomActionMsg implements org.apache.thrift.TBase<CSResponseRoomActionMsg, CSResponseRoomActionMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSResponseRoomActionMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new CSResponseRoomActionMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSResponseRoomActionMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSResponseRoomActionMsg.class, metaDataMap);
  }
   ...
   */
  public CSResponseRoomActionMsg(CSResponseRoomActionMsg other) {
  ...
  public CSResponseRoomActionMsg deepCopy() {
    return new CSResponseRoomActionMsg(this);
  }
  ...
  public CSResponseRoomActionMsg setActionId(int actionId) {
    this.actionId = actionId;
    setActionIdIsSet(true);
    return this;
  }
   ...
   * 请求动作角色id
   */
  public CSResponseRoomActionMsg setSrcCharId(long srcCharId) {
    this.srcCharId = srcCharId;
    setSrcCharIdIsSet(true);
    return this;
  }
   ...
   * 同意-1 拒绝-0
   */
  public CSResponseRoomActionMsg setResult(byte result) {
    this.result = result;
    setResultIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSResponseRoomActionMsg)
      return this.equals((CSResponseRoomActionMsg)that);
    return false;
  }

  public boolean equals(CSResponseRoomActionMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSResponseRoomActionMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSResponseRoomActionMsg typedOther = (CSResponseRoomActionMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSResponseRoomActionMsg(");
    boolean first = true;
  ...
  private static class CSResponseRoomActionMsgStandardSchemeFactory implements SchemeFactory {
    public CSResponseRoomActionMsgStandardScheme getScheme() {
      return new CSResponseRoomActionMsgStandardScheme();
    }
  }

  private static class CSResponseRoomActionMsgStandardScheme extends StandardScheme<CSResponseRoomActionMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSResponseRoomActionMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSResponseRoomActionMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSResponseRoomActionMsgTupleSchemeFactory implements SchemeFactory {
    public CSResponseRoomActionMsgTupleScheme getScheme() {
      return new CSResponseRoomActionMsgTupleScheme();
    }
  }

  private static class CSResponseRoomActionMsgTupleScheme extends TupleScheme<CSResponseRoomActionMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSResponseRoomActionMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSResponseRoomActionMsg struct) throws org.apache.thrift.TException {
