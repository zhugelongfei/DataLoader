...
public class SimplePartnerInfo implements org.apache.thrift.TBase<SimplePartnerInfo, SimplePartnerInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SimplePartnerInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new SimplePartnerInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SimplePartnerInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SimplePartnerInfo.class, metaDataMap);
  }
   ...
   */
  public SimplePartnerInfo(SimplePartnerInfo other) {
  ...
  public SimplePartnerInfo deepCopy() {
    return new SimplePartnerInfo(this);
  }
  ...
  public SimplePartnerInfo setCharId(long charId) {
    this.charId = charId;
    setCharIdIsSet(true);
    return this;
  }
  ...
  public SimplePartnerInfo setStartActionId(short startActionId) {
    this.startActionId = startActionId;
    setStartActionIdIsSet(true);
    return this;
  }
  ...
  public SimplePartnerInfo setFinishActionIds(List<Short> finishActionIds) {
    this.finishActionIds = finishActionIds;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SimplePartnerInfo)
      return this.equals((SimplePartnerInfo)that);
    return false;
  }

  public boolean equals(SimplePartnerInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SimplePartnerInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SimplePartnerInfo typedOther = (SimplePartnerInfo)other;
  ...
  private static class SimplePartnerInfoStandardSchemeFactory implements SchemeFactory {
    public SimplePartnerInfoStandardScheme getScheme() {
      return new SimplePartnerInfoStandardScheme();
    }
  }

  private static class SimplePartnerInfoStandardScheme extends StandardScheme<SimplePartnerInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SimplePartnerInfo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.finishActionIds = new ArrayList<Short>(_list58.size);
                for (int _i59 = 0; _i59 < _list58.size; ++_i59)
                {
                  short _elem60; // required
                  _elem60 = iprot.readI16();
                  struct.finishActionIds.add(_elem60);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SimplePartnerInfo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.finishActionIds != null) {
        oprot.writeFieldBegin(FINISH_ACTION_IDS_FIELD_DESC);
        {
          ...
          for (short _iter61 : struct.finishActionIds)
          {
  ...
  private static class SimplePartnerInfoTupleSchemeFactory implements SchemeFactory {
    public SimplePartnerInfoTupleScheme getScheme() {
      return new SimplePartnerInfoTupleScheme();
    }
  }

  private static class SimplePartnerInfoTupleScheme extends TupleScheme<SimplePartnerInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SimplePartnerInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFinishActionIds()) {
        {
          ...
          for (short _iter62 : struct.finishActionIds)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SimplePartnerInfo struct) throws org.apache.thrift.TException {
