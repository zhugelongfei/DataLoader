...
public class BattleTeamMemberInfo implements org.apache.thrift.TBase<BattleTeamMemberInfo, BattleTeamMemberInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BattleTeamMemberInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new BattleTeamMemberInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BattleTeamMemberInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BattleTeamMemberInfo.class, metaDataMap);
  }
   ...
   */
  public BattleTeamMemberInfo(BattleTeamMemberInfo other) {
    __isset_bitfield = other.__isset_bitfield;
    this.charId = other.charId;
    this.score = other.score;
  }

  public BattleTeamMemberInfo deepCopy() {
    return new BattleTeamMemberInfo(this);
  }
  ...
  public BattleTeamMemberInfo setCharId(long charId) {
    this.charId = charId;
    setCharIdIsSet(true);
    return this;
  }
  ...
  public BattleTeamMemberInfo setScore(int score) {
    this.score = score;
    setScoreIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BattleTeamMemberInfo)
      return this.equals((BattleTeamMemberInfo)that);
    return false;
  }

  public boolean equals(BattleTeamMemberInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(BattleTeamMemberInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    BattleTeamMemberInfo typedOther = (BattleTeamMemberInfo)other;
  ...
  private static class BattleTeamMemberInfoStandardSchemeFactory implements SchemeFactory {
    public BattleTeamMemberInfoStandardScheme getScheme() {
      return new BattleTeamMemberInfoStandardScheme();
    }
  }

  private static class BattleTeamMemberInfoStandardScheme extends StandardScheme<BattleTeamMemberInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BattleTeamMemberInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BattleTeamMemberInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BattleTeamMemberInfoTupleSchemeFactory implements SchemeFactory {
    public BattleTeamMemberInfoTupleScheme getScheme() {
      return new BattleTeamMemberInfoTupleScheme();
    }
  }

  private static class BattleTeamMemberInfoTupleScheme extends TupleScheme<BattleTeamMemberInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BattleTeamMemberInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BattleTeamMemberInfo struct) throws org.apache.thrift.TException {
