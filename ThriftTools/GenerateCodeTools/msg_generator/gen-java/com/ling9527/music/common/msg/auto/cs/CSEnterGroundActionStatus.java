 ...
 * 进入广场行为状态
 */
public class CSEnterGroundActionStatus implements org.apache.thrift.TBase<CSEnterGroundActionStatus, CSEnterGroundActionStatus._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSEnterGroundActionStatus");

  private static final org.apache.thrift.protocol.TField ACTION_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("actionStatus", org.apache.thrift.protocol.TType.BYTE, (short)1);
  private static final org.apache.thrift.protocol.TField OBJ_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("objId", org.apache.thrift.protocol.TType.I32, (short)2);
  private static final org.apache.thrift.protocol.TField OBJ_PARAM_FIELD_DESC = new org.apache.thrift.protocol.TField("objParam", org.apache.thrift.protocol.TType.I32, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new CSEnterGroundActionStatusStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSEnterGroundActionStatusTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 行为状态GroundActionStatus
     */
    ACTION_STATUS((short)1, "actionStatus"),
    /**
     * 广场部件id
     */
  ...
  private static final int __ACTIONSTATUS_ISSET_ID = 0;
  private static final int __OBJID_ISSET_ID = 1;
  private static final int __OBJPARAM_ISSET_ID = 2;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSEnterGroundActionStatus.class, metaDataMap);
  }
   ...
   */
  public CSEnterGroundActionStatus(CSEnterGroundActionStatus other) {
  ...
  public CSEnterGroundActionStatus deepCopy() {
    return new CSEnterGroundActionStatus(this);
  }
   ...
   * 行为状态GroundActionStatus
   */
  public CSEnterGroundActionStatus setActionStatus(byte actionStatus) {
    this.actionStatus = actionStatus;
    setActionStatusIsSet(true);
    return this;
  }
   ...
   * 广场部件id
   */
  public CSEnterGroundActionStatus setObjId(int objId) {
    this.objId = objId;
    setObjIdIsSet(true);
    return this;
  }
   ...
   * 广场部件参数
   */
  public CSEnterGroundActionStatus setObjParam(int objParam) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSEnterGroundActionStatus)
      return this.equals((CSEnterGroundActionStatus)that);
    return false;
  }

  public boolean equals(CSEnterGroundActionStatus that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSEnterGroundActionStatus other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSEnterGroundActionStatus typedOther = (CSEnterGroundActionStatus)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSEnterGroundActionStatus(");
    boolean first = true;
  ...
  private static class CSEnterGroundActionStatusStandardSchemeFactory implements SchemeFactory {
    public CSEnterGroundActionStatusStandardScheme getScheme() {
      return new CSEnterGroundActionStatusStandardScheme();
    }
  }

  private static class CSEnterGroundActionStatusStandardScheme extends StandardScheme<CSEnterGroundActionStatus> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSEnterGroundActionStatus struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSEnterGroundActionStatus struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSEnterGroundActionStatusTupleSchemeFactory implements SchemeFactory {
    public CSEnterGroundActionStatusTupleScheme getScheme() {
      return new CSEnterGroundActionStatusTupleScheme();
    }
  }

  private static class CSEnterGroundActionStatusTupleScheme extends TupleScheme<CSEnterGroundActionStatus> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSEnterGroundActionStatus struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSEnterGroundActionStatus struct) throws org.apache.thrift.TException {
