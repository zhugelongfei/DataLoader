...
public class FuncRespParam71 implements org.apache.thrift.TBase<FuncRespParam71, FuncRespParam71._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FuncRespParam71");
  ...
  static {
    schemes.put(StandardScheme.class, new FuncRespParam71StandardSchemeFactory());
    schemes.put(TupleScheme.class, new FuncRespParam71TupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FuncRespParam71.class, metaDataMap);
  }
   ...
   */
  public FuncRespParam71(FuncRespParam71 other) {
    __isset_bitfield = other.__isset_bitfield;
    this.durationTime = other.durationTime;
    this.cd = other.cd;
  }

  public FuncRespParam71 deepCopy() {
    return new FuncRespParam71(this);
  }
  ...
  public FuncRespParam71 setDurationTime(short durationTime) {
    this.durationTime = durationTime;
    setDurationTimeIsSet(true);
    return this;
  }
  ...
  public FuncRespParam71 setCd(short cd) {
    this.cd = cd;
    setCdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FuncRespParam71)
      return this.equals((FuncRespParam71)that);
    return false;
  }

  public boolean equals(FuncRespParam71 that) {
    if (that == null)
      return false;
  ...
  public int compareTo(FuncRespParam71 other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    FuncRespParam71 typedOther = (FuncRespParam71)other;
  ...
  private static class FuncRespParam71StandardSchemeFactory implements SchemeFactory {
    public FuncRespParam71StandardScheme getScheme() {
      return new FuncRespParam71StandardScheme();
    }
  }

  private static class FuncRespParam71StandardScheme extends StandardScheme<FuncRespParam71> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FuncRespParam71 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FuncRespParam71 struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FuncRespParam71TupleSchemeFactory implements SchemeFactory {
    public FuncRespParam71TupleScheme getScheme() {
      return new FuncRespParam71TupleScheme();
    }
  }

  private static class FuncRespParam71TupleScheme extends TupleScheme<FuncRespParam71> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FuncRespParam71 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FuncRespParam71 struct) throws org.apache.thrift.TException {
