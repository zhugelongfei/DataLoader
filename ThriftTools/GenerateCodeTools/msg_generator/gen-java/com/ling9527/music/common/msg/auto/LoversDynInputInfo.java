...
public class LoversDynInputInfo implements org.apache.thrift.TBase<LoversDynInputInfo, LoversDynInputInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("LoversDynInputInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new LoversDynInputInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LoversDynInputInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(LoversDynInputInfo.class, metaDataMap);
  }
   ...
   */
  public LoversDynInputInfo(LoversDynInputInfo other) {
  ...
  public LoversDynInputInfo deepCopy() {
    return new LoversDynInputInfo(this);
  }
  ...
  public LoversDynInputInfo setInputType(byte inputType) {
    this.inputType = inputType;
    setInputTypeIsSet(true);
    return this;
  }
  ...
  public LoversDynInputInfo setResult(byte result) {
    this.result = result;
    setResultIsSet(true);
    return this;
  }
  ...
  public LoversDynInputInfo setCombo(byte combo) {
    this.combo = combo;
    setComboIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof LoversDynInputInfo)
      return this.equals((LoversDynInputInfo)that);
    return false;
  }

  public boolean equals(LoversDynInputInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(LoversDynInputInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    LoversDynInputInfo typedOther = (LoversDynInputInfo)other;
  ...
  private static class LoversDynInputInfoStandardSchemeFactory implements SchemeFactory {
    public LoversDynInputInfoStandardScheme getScheme() {
      return new LoversDynInputInfoStandardScheme();
    }
  }

  private static class LoversDynInputInfoStandardScheme extends StandardScheme<LoversDynInputInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, LoversDynInputInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LoversDynInputInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class LoversDynInputInfoTupleSchemeFactory implements SchemeFactory {
    public LoversDynInputInfoTupleScheme getScheme() {
      return new LoversDynInputInfoTupleScheme();
    }
  }

  private static class LoversDynInputInfoTupleScheme extends TupleScheme<LoversDynInputInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, LoversDynInputInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, LoversDynInputInfo struct) throws org.apache.thrift.TException {
