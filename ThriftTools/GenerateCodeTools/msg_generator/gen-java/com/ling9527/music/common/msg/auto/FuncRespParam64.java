...
public class FuncRespParam64 implements org.apache.thrift.TBase<FuncRespParam64, FuncRespParam64._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FuncRespParam64");
  ...
  static {
    schemes.put(StandardScheme.class, new FuncRespParam64StandardSchemeFactory());
    schemes.put(TupleScheme.class, new FuncRespParam64TupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FuncRespParam64.class, metaDataMap);
  }

  public FuncRespParam64() {
  }
   ...
   */
  public FuncRespParam64(FuncRespParam64 other) {
    __isset_bitfield = other.__isset_bitfield;
    this.durationTime = other.durationTime;
    this.cd = other.cd;
  }

  public FuncRespParam64 deepCopy() {
    return new FuncRespParam64(this);
  }
  ...
  public FuncRespParam64 setDurationTime(short durationTime) {
    this.durationTime = durationTime;
    setDurationTimeIsSet(true);
    return this;
  }
  ...
  public FuncRespParam64 setCd(short cd) {
    this.cd = cd;
    setCdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FuncRespParam64)
      return this.equals((FuncRespParam64)that);
    return false;
  }

  public boolean equals(FuncRespParam64 that) {
    if (that == null)
      return false;
  ...
  public int compareTo(FuncRespParam64 other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    FuncRespParam64 typedOther = (FuncRespParam64)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FuncRespParam64(");
    boolean first = true;
  ...
  private static class FuncRespParam64StandardSchemeFactory implements SchemeFactory {
    public FuncRespParam64StandardScheme getScheme() {
      return new FuncRespParam64StandardScheme();
    }
  }

  private static class FuncRespParam64StandardScheme extends StandardScheme<FuncRespParam64> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FuncRespParam64 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FuncRespParam64 struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FuncRespParam64TupleSchemeFactory implements SchemeFactory {
    public FuncRespParam64TupleScheme getScheme() {
      return new FuncRespParam64TupleScheme();
    }
  }

  private static class FuncRespParam64TupleScheme extends TupleScheme<FuncRespParam64> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FuncRespParam64 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FuncRespParam64 struct) throws org.apache.thrift.TException {
