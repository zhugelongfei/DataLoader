 ...
 * 刷新商店成功
 */
public class SCRefreshAnnounceShopSucc implements org.apache.thrift.TBase<SCRefreshAnnounceShopSucc, SCRefreshAnnounceShopSucc._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCRefreshAnnounceShopSucc");
  ...
  private static final org.apache.thrift.protocol.TField REFRESH_COST_FIELD_DESC = new org.apache.thrift.protocol.TField("refreshCost", org.apache.thrift.protocol.TType.I32, (short)2);
  private static final org.apache.thrift.protocol.TField LEFT_FREE_TIMES_FIELD_DESC = new org.apache.thrift.protocol.TField("leftFreeTimes", org.apache.thrift.protocol.TType.I16, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new SCRefreshAnnounceShopSuccStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCRefreshAnnounceShopSuccTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 下次刷新的消耗
     */
    REFRESH_COST((short)2, "refreshCost"),
    /**
     * 剩余免费刷新次数
     */
    LEFT_FREE_TIMES((short)3, "leftFreeTimes");
  ...
  private static final int __REFRESHCOST_ISSET_ID = 0;
  private static final int __LEFTFREETIMES_ISSET_ID = 1;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCRefreshAnnounceShopSucc.class, metaDataMap);
  }
   ...
   */
  public SCRefreshAnnounceShopSucc(SCRefreshAnnounceShopSucc other) {
  ...
  public SCRefreshAnnounceShopSucc deepCopy() {
    return new SCRefreshAnnounceShopSucc(this);
  }
   ...
   * key : 商品id ,val: 商品消耗
   */
  public SCRefreshAnnounceShopSucc setItems(List<com.ling9527.music.common.msg.auto.ItemObject> items) {
    this.items = items;
    return this;
  }
   ...
   * 下次刷新的消耗
   */
  public SCRefreshAnnounceShopSucc setRefreshCost(int refreshCost) {
    this.refreshCost = refreshCost;
    setRefreshCostIsSet(true);
    return this;
  }
   ...
   * 剩余免费刷新次数
   */
  public SCRefreshAnnounceShopSucc setLeftFreeTimes(short leftFreeTimes) {
    this.leftFreeTimes = leftFreeTimes;
    setLeftFreeTimesIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCRefreshAnnounceShopSucc)
      return this.equals((SCRefreshAnnounceShopSucc)that);
    return false;
  }

  public boolean equals(SCRefreshAnnounceShopSucc that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCRefreshAnnounceShopSucc other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCRefreshAnnounceShopSucc typedOther = (SCRefreshAnnounceShopSucc)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCRefreshAnnounceShopSucc(");
    boolean first = true;
  ...
  private static class SCRefreshAnnounceShopSuccStandardSchemeFactory implements SchemeFactory {
    public SCRefreshAnnounceShopSuccStandardScheme getScheme() {
      return new SCRefreshAnnounceShopSuccStandardScheme();
    }
  }

  private static class SCRefreshAnnounceShopSuccStandardScheme extends StandardScheme<SCRefreshAnnounceShopSucc> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCRefreshAnnounceShopSucc struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.items = new ArrayList<com.ling9527.music.common.msg.auto.ItemObject>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  com.ling9527.music.common.msg.auto.ItemObject _elem18; // required
                  _elem18 = new com.ling9527.music.common.msg.auto.ItemObject();
                  _elem18.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCRefreshAnnounceShopSucc struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.items != null) {
        oprot.writeFieldBegin(ITEMS_FIELD_DESC);
        {
          ...
          for (com.ling9527.music.common.msg.auto.ItemObject _iter19 : struct.items)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class SCRefreshAnnounceShopSuccTupleSchemeFactory implements SchemeFactory {
    public SCRefreshAnnounceShopSuccTupleScheme getScheme() {
      return new SCRefreshAnnounceShopSuccTupleScheme();
    }
  }

  private static class SCRefreshAnnounceShopSuccTupleScheme extends TupleScheme<SCRefreshAnnounceShopSucc> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCRefreshAnnounceShopSucc struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (com.ling9527.music.common.msg.auto.ItemObject _iter20 : struct.items)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCRefreshAnnounceShopSucc struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list21 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<com.ling9527.music.common.msg.auto.ItemObject>(_list21.size);
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            com.ling9527.music.common.msg.auto.ItemObject _elem23; // required
            _elem23 = new com.ling9527.music.common.msg.auto.ItemObject();
            _elem23.read(iprot);
