...
public class CSOverWishMsg implements org.apache.thrift.TBase<CSOverWishMsg, CSOverWishMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSOverWishMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new CSOverWishMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSOverWishMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSOverWishMsg.class, metaDataMap);
  }
   ...
   */
  public CSOverWishMsg(CSOverWishMsg other) {
    __isset_bitfield = other.__isset_bitfield;
    this.charId = other.charId;
    this.wishId = other.wishId;
  }

  public CSOverWishMsg deepCopy() {
    return new CSOverWishMsg(this);
  }
  ...
  public CSOverWishMsg setCharId(long charId) {
    this.charId = charId;
    setCharIdIsSet(true);
    return this;
  }
  ...
  public CSOverWishMsg setWishId(long wishId) {
    this.wishId = wishId;
    setWishIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSOverWishMsg)
      return this.equals((CSOverWishMsg)that);
    return false;
  }

  public boolean equals(CSOverWishMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSOverWishMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSOverWishMsg typedOther = (CSOverWishMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSOverWishMsg(");
    boolean first = true;
  ...
  private static class CSOverWishMsgStandardSchemeFactory implements SchemeFactory {
    public CSOverWishMsgStandardScheme getScheme() {
      return new CSOverWishMsgStandardScheme();
    }
  }

  private static class CSOverWishMsgStandardScheme extends StandardScheme<CSOverWishMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSOverWishMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSOverWishMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSOverWishMsgTupleSchemeFactory implements SchemeFactory {
    public CSOverWishMsgTupleScheme getScheme() {
      return new CSOverWishMsgTupleScheme();
    }
  }

  private static class CSOverWishMsgTupleScheme extends TupleScheme<CSOverWishMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSOverWishMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSOverWishMsg struct) throws org.apache.thrift.TException {
