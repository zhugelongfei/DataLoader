 ...
 * 请求巡演关卡详细信息
 */
public class CSReqTourRaidDetailMsg implements org.apache.thrift.TBase<CSReqTourRaidDetailMsg, CSReqTourRaidDetailMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSReqTourRaidDetailMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new CSReqTourRaidDetailMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSReqTourRaidDetailMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSReqTourRaidDetailMsg.class, metaDataMap);
  }
   ...
   */
  public CSReqTourRaidDetailMsg(CSReqTourRaidDetailMsg other) {
    __isset_bitfield = other.__isset_bitfield;
    this.chapterId = other.chapterId;
    this.raidId = other.raidId;
  }

  public CSReqTourRaidDetailMsg deepCopy() {
    return new CSReqTourRaidDetailMsg(this);
  }
   ...
   * 章节id
   */
  public CSReqTourRaidDetailMsg setChapterId(short chapterId) {
    this.chapterId = chapterId;
    setChapterIdIsSet(true);
    return this;
  }
   ...
   * 关卡id
   */
  public CSReqTourRaidDetailMsg setRaidId(short raidId) {
    this.raidId = raidId;
    setRaidIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSReqTourRaidDetailMsg)
      return this.equals((CSReqTourRaidDetailMsg)that);
    return false;
  }

  public boolean equals(CSReqTourRaidDetailMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSReqTourRaidDetailMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSReqTourRaidDetailMsg typedOther = (CSReqTourRaidDetailMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSReqTourRaidDetailMsg(");
    boolean first = true;
  ...
  private static class CSReqTourRaidDetailMsgStandardSchemeFactory implements SchemeFactory {
    public CSReqTourRaidDetailMsgStandardScheme getScheme() {
      return new CSReqTourRaidDetailMsgStandardScheme();
    }
  }

  private static class CSReqTourRaidDetailMsgStandardScheme extends StandardScheme<CSReqTourRaidDetailMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSReqTourRaidDetailMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSReqTourRaidDetailMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSReqTourRaidDetailMsgTupleSchemeFactory implements SchemeFactory {
    public CSReqTourRaidDetailMsgTupleScheme getScheme() {
      return new CSReqTourRaidDetailMsgTupleScheme();
    }
  }

  private static class CSReqTourRaidDetailMsgTupleScheme extends TupleScheme<CSReqTourRaidDetailMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSReqTourRaidDetailMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSReqTourRaidDetailMsg struct) throws org.apache.thrift.TException {
