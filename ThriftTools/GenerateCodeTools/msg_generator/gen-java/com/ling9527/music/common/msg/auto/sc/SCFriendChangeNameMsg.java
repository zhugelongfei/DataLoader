 ...
 */
public class SCFriendChangeNameMsg implements org.apache.thrift.TBase<SCFriendChangeNameMsg, SCFriendChangeNameMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCFriendChangeNameMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new SCFriendChangeNameMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCFriendChangeNameMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCFriendChangeNameMsg.class, metaDataMap);
  }
   ...
   */
  public SCFriendChangeNameMsg(SCFriendChangeNameMsg other) {
  ...
  public SCFriendChangeNameMsg deepCopy() {
    return new SCFriendChangeNameMsg(this);
  }
  ...
  public SCFriendChangeNameMsg setCharId(long charId) {
    this.charId = charId;
    setCharIdIsSet(true);
    return this;
  }
  ...
  public SCFriendChangeNameMsg setCharName(String charName) {
    this.charName = charName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCFriendChangeNameMsg)
      return this.equals((SCFriendChangeNameMsg)that);
    return false;
  }

  public boolean equals(SCFriendChangeNameMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCFriendChangeNameMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCFriendChangeNameMsg typedOther = (SCFriendChangeNameMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCFriendChangeNameMsg(");
    boolean first = true;
  ...
  private static class SCFriendChangeNameMsgStandardSchemeFactory implements SchemeFactory {
    public SCFriendChangeNameMsgStandardScheme getScheme() {
      return new SCFriendChangeNameMsgStandardScheme();
    }
  }

  private static class SCFriendChangeNameMsgStandardScheme extends StandardScheme<SCFriendChangeNameMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCFriendChangeNameMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCFriendChangeNameMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCFriendChangeNameMsgTupleSchemeFactory implements SchemeFactory {
    public SCFriendChangeNameMsgTupleScheme getScheme() {
      return new SCFriendChangeNameMsgTupleScheme();
    }
  }

  private static class SCFriendChangeNameMsgTupleScheme extends TupleScheme<SCFriendChangeNameMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCFriendChangeNameMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCFriendChangeNameMsg struct) throws org.apache.thrift.TException {
