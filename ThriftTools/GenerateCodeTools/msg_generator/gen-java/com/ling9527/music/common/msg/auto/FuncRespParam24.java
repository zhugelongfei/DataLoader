...
public class FuncRespParam24 implements org.apache.thrift.TBase<FuncRespParam24, FuncRespParam24._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FuncRespParam24");
  ...
  static {
    schemes.put(StandardScheme.class, new FuncRespParam24StandardSchemeFactory());
    schemes.put(TupleScheme.class, new FuncRespParam24TupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FuncRespParam24.class, metaDataMap);
  }
   ...
   */
  public FuncRespParam24(FuncRespParam24 other) {
  ...
  public FuncRespParam24 deepCopy() {
    return new FuncRespParam24(this);
  }
  ...
  public FuncRespParam24 setItemPrizeList(List<com.ling9527.music.common.msg.auto.ItemPrize> itemPrizeList) {
    this.itemPrizeList = itemPrizeList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FuncRespParam24)
      return this.equals((FuncRespParam24)that);
    return false;
  }

  public boolean equals(FuncRespParam24 that) {
    if (that == null)
      return false;
  ...
  public int compareTo(FuncRespParam24 other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    FuncRespParam24 typedOther = (FuncRespParam24)other;
  ...
  private static class FuncRespParam24StandardSchemeFactory implements SchemeFactory {
    public FuncRespParam24StandardScheme getScheme() {
      return new FuncRespParam24StandardScheme();
    }
  }

  private static class FuncRespParam24StandardScheme extends StandardScheme<FuncRespParam24> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FuncRespParam24 struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.itemPrizeList = new ArrayList<com.ling9527.music.common.msg.auto.ItemPrize>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  com.ling9527.music.common.msg.auto.ItemPrize _elem10; // required
                  _elem10 = new com.ling9527.music.common.msg.auto.ItemPrize();
                  _elem10.read(iprot);
                  struct.itemPrizeList.add(_elem10);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FuncRespParam24 struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.itemPrizeList != null) {
        oprot.writeFieldBegin(ITEM_PRIZE_LIST_FIELD_DESC);
        {
          ...
          for (com.ling9527.music.common.msg.auto.ItemPrize _iter11 : struct.itemPrizeList)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class FuncRespParam24TupleSchemeFactory implements SchemeFactory {
    public FuncRespParam24TupleScheme getScheme() {
      return new FuncRespParam24TupleScheme();
    }
  }

  private static class FuncRespParam24TupleScheme extends TupleScheme<FuncRespParam24> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FuncRespParam24 struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetItemPrizeList()) {
        {
          ...
          for (com.ling9527.music.common.msg.auto.ItemPrize _iter12 : struct.itemPrizeList)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FuncRespParam24 struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(1);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list13 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.itemPrizeList = new ArrayList<com.ling9527.music.common.msg.auto.ItemPrize>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            com.ling9527.music.common.msg.auto.ItemPrize _elem15; // required
            _elem15 = new com.ling9527.music.common.msg.auto.ItemPrize();
            _elem15.read(iprot);
            struct.itemPrizeList.add(_elem15);
          }
        }
        struct.setItemPrizeListIsSet(true);
      }
