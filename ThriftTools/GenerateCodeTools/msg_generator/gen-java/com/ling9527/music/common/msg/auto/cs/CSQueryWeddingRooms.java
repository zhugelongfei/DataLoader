 ...
 * 查询婚礼房间
 */
public class CSQueryWeddingRooms implements org.apache.thrift.TBase<CSQueryWeddingRooms, CSQueryWeddingRooms._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSQueryWeddingRooms");
  ...
  static {
    schemes.put(StandardScheme.class, new CSQueryWeddingRoomsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSQueryWeddingRoomsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSQueryWeddingRooms.class, metaDataMap);
  }
   ...
   */
  public CSQueryWeddingRooms(CSQueryWeddingRooms other) {
  ...
  public CSQueryWeddingRooms deepCopy() {
    return new CSQueryWeddingRooms(this);
  }
   ...
   * 分页信息查询参数
   */
  public CSQueryWeddingRooms setPageInfoQueryParam(com.ling9527.music.common.msg.auto.CommonDataPageInfoQueryParam pageInfoQueryParam) {
    this.pageInfoQueryParam = pageInfoQueryParam;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSQueryWeddingRooms)
      return this.equals((CSQueryWeddingRooms)that);
    return false;
  }

  public boolean equals(CSQueryWeddingRooms that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSQueryWeddingRooms other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSQueryWeddingRooms typedOther = (CSQueryWeddingRooms)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSQueryWeddingRooms(");
    boolean first = true;
  ...
  private static class CSQueryWeddingRoomsStandardSchemeFactory implements SchemeFactory {
    public CSQueryWeddingRoomsStandardScheme getScheme() {
      return new CSQueryWeddingRoomsStandardScheme();
    }
  }

  private static class CSQueryWeddingRoomsStandardScheme extends StandardScheme<CSQueryWeddingRooms> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSQueryWeddingRooms struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSQueryWeddingRooms struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSQueryWeddingRoomsTupleSchemeFactory implements SchemeFactory {
    public CSQueryWeddingRoomsTupleScheme getScheme() {
      return new CSQueryWeddingRoomsTupleScheme();
    }
  }

  private static class CSQueryWeddingRoomsTupleScheme extends TupleScheme<CSQueryWeddingRooms> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSQueryWeddingRooms struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSQueryWeddingRooms struct) throws org.apache.thrift.TException {
