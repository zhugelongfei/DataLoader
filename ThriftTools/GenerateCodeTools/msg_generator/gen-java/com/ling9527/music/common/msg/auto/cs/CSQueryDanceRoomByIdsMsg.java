 ...
 * 请求对应id的竞技房间信息
 */
public class CSQueryDanceRoomByIdsMsg implements org.apache.thrift.TBase<CSQueryDanceRoomByIdsMsg, CSQueryDanceRoomByIdsMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSQueryDanceRoomByIdsMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new CSQueryDanceRoomByIdsMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSQueryDanceRoomByIdsMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSQueryDanceRoomByIdsMsg.class, metaDataMap);
  }

  public CSQueryDanceRoomByIdsMsg() {
  }
   ...
   */
  public CSQueryDanceRoomByIdsMsg(CSQueryDanceRoomByIdsMsg other) {
  ...
  public CSQueryDanceRoomByIdsMsg deepCopy() {
    return new CSQueryDanceRoomByIdsMsg(this);
  }
   ...
   * 请求对应id的信息参数
   */
  public CSQueryDanceRoomByIdsMsg setQueryByIdsParam(com.ling9527.music.common.msg.auto.CommonDataQueryByIdsParam queryByIdsParam) {
    this.queryByIdsParam = queryByIdsParam;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSQueryDanceRoomByIdsMsg)
      return this.equals((CSQueryDanceRoomByIdsMsg)that);
    return false;
  }

  public boolean equals(CSQueryDanceRoomByIdsMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSQueryDanceRoomByIdsMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSQueryDanceRoomByIdsMsg typedOther = (CSQueryDanceRoomByIdsMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSQueryDanceRoomByIdsMsg(");
    boolean first = true;
  ...
  private static class CSQueryDanceRoomByIdsMsgStandardSchemeFactory implements SchemeFactory {
    public CSQueryDanceRoomByIdsMsgStandardScheme getScheme() {
      return new CSQueryDanceRoomByIdsMsgStandardScheme();
    }
  }

  private static class CSQueryDanceRoomByIdsMsgStandardScheme extends StandardScheme<CSQueryDanceRoomByIdsMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSQueryDanceRoomByIdsMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSQueryDanceRoomByIdsMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSQueryDanceRoomByIdsMsgTupleSchemeFactory implements SchemeFactory {
    public CSQueryDanceRoomByIdsMsgTupleScheme getScheme() {
      return new CSQueryDanceRoomByIdsMsgTupleScheme();
    }
  }

  private static class CSQueryDanceRoomByIdsMsgTupleScheme extends TupleScheme<CSQueryDanceRoomByIdsMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSQueryDanceRoomByIdsMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSQueryDanceRoomByIdsMsg struct) throws org.apache.thrift.TException {
