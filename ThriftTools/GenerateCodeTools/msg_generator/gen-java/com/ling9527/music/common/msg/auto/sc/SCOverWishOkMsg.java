...
public class SCOverWishOkMsg implements org.apache.thrift.TBase<SCOverWishOkMsg, SCOverWishOkMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCOverWishOkMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new SCOverWishOkMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCOverWishOkMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCOverWishOkMsg.class, metaDataMap);
  }

  public SCOverWishOkMsg() {
  }
   ...
   */
  public SCOverWishOkMsg(SCOverWishOkMsg other) {
    __isset_bitfield = other.__isset_bitfield;
    this.wishId = other.wishId;
    this.charId = other.charId;
  }

  public SCOverWishOkMsg deepCopy() {
    return new SCOverWishOkMsg(this);
  }
  ...
  public SCOverWishOkMsg setWishId(long wishId) {
    this.wishId = wishId;
    setWishIdIsSet(true);
    return this;
  }
  ...
  public SCOverWishOkMsg setCharId(long charId) {
    this.charId = charId;
    setCharIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCOverWishOkMsg)
      return this.equals((SCOverWishOkMsg)that);
    return false;
  }

  public boolean equals(SCOverWishOkMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCOverWishOkMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCOverWishOkMsg typedOther = (SCOverWishOkMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCOverWishOkMsg(");
    boolean first = true;
  ...
  private static class SCOverWishOkMsgStandardSchemeFactory implements SchemeFactory {
    public SCOverWishOkMsgStandardScheme getScheme() {
      return new SCOverWishOkMsgStandardScheme();
    }
  }

  private static class SCOverWishOkMsgStandardScheme extends StandardScheme<SCOverWishOkMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCOverWishOkMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCOverWishOkMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCOverWishOkMsgTupleSchemeFactory implements SchemeFactory {
    public SCOverWishOkMsgTupleScheme getScheme() {
      return new SCOverWishOkMsgTupleScheme();
    }
  }

  private static class SCOverWishOkMsgTupleScheme extends TupleScheme<SCOverWishOkMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCOverWishOkMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCOverWishOkMsg struct) throws org.apache.thrift.TException {
