 ...
 * 成功领取活动目标奖励
 */
public class SCGetActivityTargetPrizeSucc implements org.apache.thrift.TBase<SCGetActivityTargetPrizeSucc, SCGetActivityTargetPrizeSucc._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCGetActivityTargetPrizeSucc");
  ...
  private static final org.apache.thrift.protocol.TField TARGET_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("targetId", org.apache.thrift.protocol.TType.I32, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new SCGetActivityTargetPrizeSuccStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCGetActivityTargetPrizeSuccTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCGetActivityTargetPrizeSucc.class, metaDataMap);
  }
   ...
   */
  public SCGetActivityTargetPrizeSucc(SCGetActivityTargetPrizeSucc other) {
    __isset_bitfield = other.__isset_bitfield;
    this.activityId = other.activityId;
    this.targetId = other.targetId;
  }

  public SCGetActivityTargetPrizeSucc deepCopy() {
    return new SCGetActivityTargetPrizeSucc(this);
  }
  ...
  public SCGetActivityTargetPrizeSucc setActivityId(int activityId) {
    this.activityId = activityId;
    setActivityIdIsSet(true);
    return this;
  }
   ...
   * 目标id
   */
  public SCGetActivityTargetPrizeSucc setTargetId(int targetId) {
    this.targetId = targetId;
    setTargetIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCGetActivityTargetPrizeSucc)
      return this.equals((SCGetActivityTargetPrizeSucc)that);
    return false;
  }

  public boolean equals(SCGetActivityTargetPrizeSucc that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCGetActivityTargetPrizeSucc other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCGetActivityTargetPrizeSucc typedOther = (SCGetActivityTargetPrizeSucc)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCGetActivityTargetPrizeSucc(");
    boolean first = true;
  ...
  private static class SCGetActivityTargetPrizeSuccStandardSchemeFactory implements SchemeFactory {
    public SCGetActivityTargetPrizeSuccStandardScheme getScheme() {
      return new SCGetActivityTargetPrizeSuccStandardScheme();
    }
  }

  private static class SCGetActivityTargetPrizeSuccStandardScheme extends StandardScheme<SCGetActivityTargetPrizeSucc> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCGetActivityTargetPrizeSucc struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCGetActivityTargetPrizeSucc struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCGetActivityTargetPrizeSuccTupleSchemeFactory implements SchemeFactory {
    public SCGetActivityTargetPrizeSuccTupleScheme getScheme() {
      return new SCGetActivityTargetPrizeSuccTupleScheme();
    }
  }

  private static class SCGetActivityTargetPrizeSuccTupleScheme extends TupleScheme<SCGetActivityTargetPrizeSucc> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCGetActivityTargetPrizeSucc struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCGetActivityTargetPrizeSucc struct) throws org.apache.thrift.TException {
