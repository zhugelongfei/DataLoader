 ...
 * 查询舞团团员列表
 */
public class CSQueryGuildMemListMsg implements org.apache.thrift.TBase<CSQueryGuildMemListMsg, CSQueryGuildMemListMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSQueryGuildMemListMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new CSQueryGuildMemListMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSQueryGuildMemListMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSQueryGuildMemListMsg.class, metaDataMap);
  }
   ...
   */
  public CSQueryGuildMemListMsg(CSQueryGuildMemListMsg other) {
  ...
  public CSQueryGuildMemListMsg deepCopy() {
    return new CSQueryGuildMemListMsg(this);
  }
  ...
  public CSQueryGuildMemListMsg setGuildId(long guildId) {
    this.guildId = guildId;
    setGuildIdIsSet(true);
    return this;
  }
  ...
  public CSQueryGuildMemListMsg setStartIndex(int startIndex) {
    this.startIndex = startIndex;
    setStartIndexIsSet(true);
    return this;
  }
  ...
  public CSQueryGuildMemListMsg setCount(short count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSQueryGuildMemListMsg)
      return this.equals((CSQueryGuildMemListMsg)that);
    return false;
  }

  public boolean equals(CSQueryGuildMemListMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSQueryGuildMemListMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSQueryGuildMemListMsg typedOther = (CSQueryGuildMemListMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSQueryGuildMemListMsg(");
    boolean first = true;
  ...
  private static class CSQueryGuildMemListMsgStandardSchemeFactory implements SchemeFactory {
    public CSQueryGuildMemListMsgStandardScheme getScheme() {
      return new CSQueryGuildMemListMsgStandardScheme();
    }
  }

  private static class CSQueryGuildMemListMsgStandardScheme extends StandardScheme<CSQueryGuildMemListMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSQueryGuildMemListMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSQueryGuildMemListMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSQueryGuildMemListMsgTupleSchemeFactory implements SchemeFactory {
    public CSQueryGuildMemListMsgTupleScheme getScheme() {
      return new CSQueryGuildMemListMsgTupleScheme();
    }
  }

  private static class CSQueryGuildMemListMsgTupleScheme extends TupleScheme<CSQueryGuildMemListMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSQueryGuildMemListMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSQueryGuildMemListMsg struct) throws org.apache.thrift.TException {
