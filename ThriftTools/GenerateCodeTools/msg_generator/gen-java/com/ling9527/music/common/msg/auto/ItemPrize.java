 ...
 * 道具奖励
 */
public class ItemPrize implements org.apache.thrift.TBase<ItemPrize, ItemPrize._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ItemPrize");
  ...
  static {
    schemes.put(StandardScheme.class, new ItemPrizeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ItemPrizeTupleSchemeFactory());
  }
  ...
  private static final int __VALIDTIMETYPE_ISSET_ID = 2;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ItemPrize.class, metaDataMap);
  }
   ...
   */
  public ItemPrize(ItemPrize other) {
   ...
   * item template id
   */
  public ItemPrize setItemId(int itemId) {
    this.itemId = itemId;
    setItemIdIsSet(true);
    return this;
  }
  ...
  public ItemPrize setCount(int count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public ItemPrize setValidTimeType(byte validTimeType) {
    this.validTimeType = validTimeType;
    setValidTimeTypeIsSet(true);
    return this;
  }
  ...
  public ItemPrize setRemainTime(int remainTime) {
    this.remainTime = remainTime;
    setRemainTimeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ItemPrize)
      return this.equals((ItemPrize)that);
    return false;
  }

  public boolean equals(ItemPrize that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ItemPrize other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ItemPrize typedOther = (ItemPrize)other;
  ...
  private static class ItemPrizeStandardSchemeFactory implements SchemeFactory {
    public ItemPrizeStandardScheme getScheme() {
      return new ItemPrizeStandardScheme();
    }
  }

  private static class ItemPrizeStandardScheme extends StandardScheme<ItemPrize> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ItemPrize struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ItemPrize struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ItemPrizeTupleSchemeFactory implements SchemeFactory {
    public ItemPrizeTupleScheme getScheme() {
      return new ItemPrizeTupleScheme();
    }
  }

  private static class ItemPrizeTupleScheme extends TupleScheme<ItemPrize> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ItemPrize struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ItemPrize struct) throws org.apache.thrift.TException {
