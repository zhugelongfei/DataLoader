 ...
 * 请求对应id的广场信息
 */
public class CSQueryGroundRoomByIdsMsg implements org.apache.thrift.TBase<CSQueryGroundRoomByIdsMsg, CSQueryGroundRoomByIdsMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSQueryGroundRoomByIdsMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new CSQueryGroundRoomByIdsMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSQueryGroundRoomByIdsMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSQueryGroundRoomByIdsMsg.class, metaDataMap);
  }
   ...
   */
  public CSQueryGroundRoomByIdsMsg(CSQueryGroundRoomByIdsMsg other) {
  ...
  public CSQueryGroundRoomByIdsMsg deepCopy() {
    return new CSQueryGroundRoomByIdsMsg(this);
  }
   ...
   * 请求对应id的信息参数
   */
  public CSQueryGroundRoomByIdsMsg setQueryByIdsParam(com.ling9527.music.common.msg.auto.CommonDataQueryByIdsParam queryByIdsParam) {
    this.queryByIdsParam = queryByIdsParam;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSQueryGroundRoomByIdsMsg)
      return this.equals((CSQueryGroundRoomByIdsMsg)that);
    return false;
  }

  public boolean equals(CSQueryGroundRoomByIdsMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSQueryGroundRoomByIdsMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSQueryGroundRoomByIdsMsg typedOther = (CSQueryGroundRoomByIdsMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSQueryGroundRoomByIdsMsg(");
    boolean first = true;
  ...
  private static class CSQueryGroundRoomByIdsMsgStandardSchemeFactory implements SchemeFactory {
    public CSQueryGroundRoomByIdsMsgStandardScheme getScheme() {
      return new CSQueryGroundRoomByIdsMsgStandardScheme();
    }
  }

  private static class CSQueryGroundRoomByIdsMsgStandardScheme extends StandardScheme<CSQueryGroundRoomByIdsMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSQueryGroundRoomByIdsMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSQueryGroundRoomByIdsMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSQueryGroundRoomByIdsMsgTupleSchemeFactory implements SchemeFactory {
    public CSQueryGroundRoomByIdsMsgTupleScheme getScheme() {
      return new CSQueryGroundRoomByIdsMsgTupleScheme();
    }
  }

  private static class CSQueryGroundRoomByIdsMsgTupleScheme extends TupleScheme<CSQueryGroundRoomByIdsMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSQueryGroundRoomByIdsMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSQueryGroundRoomByIdsMsg struct) throws org.apache.thrift.TException {
