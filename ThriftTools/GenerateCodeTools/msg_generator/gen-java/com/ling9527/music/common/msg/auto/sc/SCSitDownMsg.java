...
public class SCSitDownMsg implements org.apache.thrift.TBase<SCSitDownMsg, SCSitDownMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCSitDownMsg");
  ...
  static {
    schemes.put(StandardScheme.class, new SCSitDownMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCSitDownMsgTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCSitDownMsg.class, metaDataMap);
  }
   ...
   */
  public SCSitDownMsg(SCSitDownMsg other) {
    __isset_bitfield = other.__isset_bitfield;
    this.charId = other.charId;
    this.seatId = other.seatId;
  }

  public SCSitDownMsg deepCopy() {
    return new SCSitDownMsg(this);
  }
  ...
  public SCSitDownMsg setCharId(long charId) {
    this.charId = charId;
    setCharIdIsSet(true);
    return this;
  }
  ...
  public SCSitDownMsg setSeatId(short seatId) {
    this.seatId = seatId;
    setSeatIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCSitDownMsg)
      return this.equals((SCSitDownMsg)that);
    return false;
  }

  public boolean equals(SCSitDownMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCSitDownMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCSitDownMsg typedOther = (SCSitDownMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCSitDownMsg(");
    boolean first = true;
  ...
  private static class SCSitDownMsgStandardSchemeFactory implements SchemeFactory {
    public SCSitDownMsgStandardScheme getScheme() {
      return new SCSitDownMsgStandardScheme();
    }
  }

  private static class SCSitDownMsgStandardScheme extends StandardScheme<SCSitDownMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCSitDownMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCSitDownMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCSitDownMsgTupleSchemeFactory implements SchemeFactory {
    public SCSitDownMsgTupleScheme getScheme() {
      return new SCSitDownMsgTupleScheme();
    }
  }

  private static class SCSitDownMsgTupleScheme extends TupleScheme<SCSitDownMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCSitDownMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCSitDownMsg struct) throws org.apache.thrift.TException {
