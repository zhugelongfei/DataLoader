 ...
 * 续费时尚信息成功
 */
public class SCRenewFashionSucc implements org.apache.thrift.TBase<SCRenewFashionSucc, SCRenewFashionSucc._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCRenewFashionSucc");
  ...
  static {
    schemes.put(StandardScheme.class, new SCRenewFashionSuccStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCRenewFashionSuccTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCRenewFashionSucc.class, metaDataMap);
  }

  public SCRenewFashionSucc() {
  }
   ...
   */
  public SCRenewFashionSucc(SCRenewFashionSucc other) {
    __isset_bitfield = other.__isset_bitfield;
    this.fashionId = other.fashionId;
    this.validTime = other.validTime;
  }

  public SCRenewFashionSucc deepCopy() {
    return new SCRenewFashionSucc(this);
  }
   ...
   * 时尚id
   */
  public SCRenewFashionSucc setFashionId(int fashionId) {
    this.fashionId = fashionId;
    setFashionIdIsSet(true);
    return this;
  }
   ...
   * 到期时间(单位:秒)
   */
  public SCRenewFashionSucc setValidTime(int validTime) {
    this.validTime = validTime;
    setValidTimeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCRenewFashionSucc)
      return this.equals((SCRenewFashionSucc)that);
    return false;
  }

  public boolean equals(SCRenewFashionSucc that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCRenewFashionSucc other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCRenewFashionSucc typedOther = (SCRenewFashionSucc)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCRenewFashionSucc(");
    boolean first = true;
  ...
  private static class SCRenewFashionSuccStandardSchemeFactory implements SchemeFactory {
    public SCRenewFashionSuccStandardScheme getScheme() {
      return new SCRenewFashionSuccStandardScheme();
    }
  }

  private static class SCRenewFashionSuccStandardScheme extends StandardScheme<SCRenewFashionSucc> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCRenewFashionSucc struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCRenewFashionSucc struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCRenewFashionSuccTupleSchemeFactory implements SchemeFactory {
    public SCRenewFashionSuccTupleScheme getScheme() {
      return new SCRenewFashionSuccTupleScheme();
    }
  }

  private static class SCRenewFashionSuccTupleScheme extends TupleScheme<SCRenewFashionSucc> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCRenewFashionSucc struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCRenewFashionSucc struct) throws org.apache.thrift.TException {
