 ...
 * 巡演舞蹈通关信息
 */
public class SCTourDancePassInfoMsg implements org.apache.thrift.TBase<SCTourDancePassInfoMsg, SCTourDancePassInfoMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCTourDancePassInfoMsg");
  ...
  private static final org.apache.thrift.protocol.TField CHEER_PASS_INIT_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("cheerPassInitInfo", org.apache.thrift.protocol.TType.STRUCT, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new SCTourDancePassInfoMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCTourDancePassInfoMsgTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 舞蹈欢呼值通关信息
     */
    CHEER_PASS_INIT_INFO((short)3, "cheerPassInitInfo");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCTourDancePassInfoMsg.class, metaDataMap);
  }
   ...
   */
  public SCTourDancePassInfoMsg(SCTourDancePassInfoMsg other) {
  ...
  public SCTourDancePassInfoMsg deepCopy() {
    return new SCTourDancePassInfoMsg(this);
  }
   ...
   * 章节id
   */
  public SCTourDancePassInfoMsg setChapterId(short chapterId) {
    this.chapterId = chapterId;
    setChapterIdIsSet(true);
    return this;
  }
   ...
   * 关卡id
   */
  public SCTourDancePassInfoMsg setRaidId(short raidId) {
    this.raidId = raidId;
    setRaidIdIsSet(true);
    return this;
  }
   ...
   * 舞蹈欢呼值通关信息
   */
  public SCTourDancePassInfoMsg setCheerPassInitInfo(com.ling9527.music.common.msg.auto.DanceCheerInitInfo cheerPassInitInfo) {
    this.cheerPassInitInfo = cheerPassInitInfo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCTourDancePassInfoMsg)
      return this.equals((SCTourDancePassInfoMsg)that);
    return false;
  }

  public boolean equals(SCTourDancePassInfoMsg that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SCTourDancePassInfoMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SCTourDancePassInfoMsg typedOther = (SCTourDancePassInfoMsg)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SCTourDancePassInfoMsg(");
    boolean first = true;
  ...
  private static class SCTourDancePassInfoMsgStandardSchemeFactory implements SchemeFactory {
    public SCTourDancePassInfoMsgStandardScheme getScheme() {
      return new SCTourDancePassInfoMsgStandardScheme();
    }
  }

  private static class SCTourDancePassInfoMsgStandardScheme extends StandardScheme<SCTourDancePassInfoMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCTourDancePassInfoMsg struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCTourDancePassInfoMsg struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCTourDancePassInfoMsgTupleSchemeFactory implements SchemeFactory {
    public SCTourDancePassInfoMsgTupleScheme getScheme() {
      return new SCTourDancePassInfoMsgTupleScheme();
    }
  }

  private static class SCTourDancePassInfoMsgTupleScheme extends TupleScheme<SCTourDancePassInfoMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCTourDancePassInfoMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCTourDancePassInfoMsg struct) throws org.apache.thrift.TException {
