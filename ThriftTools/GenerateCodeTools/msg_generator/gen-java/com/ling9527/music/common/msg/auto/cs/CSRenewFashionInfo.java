 ...
 * 续费时尚信息
 */
public class CSRenewFashionInfo implements org.apache.thrift.TBase<CSRenewFashionInfo, CSRenewFashionInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSRenewFashionInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new CSRenewFashionInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSRenewFashionInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSRenewFashionInfo.class, metaDataMap);
  }

  public CSRenewFashionInfo() {
  }
   ...
   */
  public CSRenewFashionInfo(CSRenewFashionInfo other) {
    __isset_bitfield = other.__isset_bitfield;
    this.fashionId = other.fashionId;
    this.validTimeType = other.validTimeType;
  }

  public CSRenewFashionInfo deepCopy() {
    return new CSRenewFashionInfo(this);
  }
   ...
   * 时尚id
   */
  public CSRenewFashionInfo setFashionId(int fashionId) {
    this.fashionId = fashionId;
    setFashionIdIsSet(true);
    return this;
  }
   ...
   * 有效期类型 2-周 3-月
   */
  public CSRenewFashionInfo setValidTimeType(byte validTimeType) {
    this.validTimeType = validTimeType;
    setValidTimeTypeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSRenewFashionInfo)
      return this.equals((CSRenewFashionInfo)that);
    return false;
  }

  public boolean equals(CSRenewFashionInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSRenewFashionInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSRenewFashionInfo typedOther = (CSRenewFashionInfo)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSRenewFashionInfo(");
    boolean first = true;
  ...
  private static class CSRenewFashionInfoStandardSchemeFactory implements SchemeFactory {
    public CSRenewFashionInfoStandardScheme getScheme() {
      return new CSRenewFashionInfoStandardScheme();
    }
  }

  private static class CSRenewFashionInfoStandardScheme extends StandardScheme<CSRenewFashionInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSRenewFashionInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSRenewFashionInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSRenewFashionInfoTupleSchemeFactory implements SchemeFactory {
    public CSRenewFashionInfoTupleScheme getScheme() {
      return new CSRenewFashionInfoTupleScheme();
    }
  }

  private static class CSRenewFashionInfoTupleScheme extends TupleScheme<CSRenewFashionInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSRenewFashionInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSRenewFashionInfo struct) throws org.apache.thrift.TException {
