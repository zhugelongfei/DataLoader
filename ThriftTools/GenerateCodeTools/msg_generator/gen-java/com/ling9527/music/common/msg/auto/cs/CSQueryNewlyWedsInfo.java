 ...
 * 查询新婚夫妻信息
 */
public class CSQueryNewlyWedsInfo implements org.apache.thrift.TBase<CSQueryNewlyWedsInfo, CSQueryNewlyWedsInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSQueryNewlyWedsInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new CSQueryNewlyWedsInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSQueryNewlyWedsInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSQueryNewlyWedsInfo.class, metaDataMap);
  }
   ...
   */
  public CSQueryNewlyWedsInfo(CSQueryNewlyWedsInfo other) {
    __isset_bitfield = other.__isset_bitfield;
    this.bridegroomId = other.bridegroomId;
    this.brideId = other.brideId;
  }

  public CSQueryNewlyWedsInfo deepCopy() {
    return new CSQueryNewlyWedsInfo(this);
  }
   ...
   * 新郎角色id
   */
  public CSQueryNewlyWedsInfo setBridegroomId(long bridegroomId) {
    this.bridegroomId = bridegroomId;
    setBridegroomIdIsSet(true);
    return this;
  }
   ...
   * 新娘角色id
   */
  public CSQueryNewlyWedsInfo setBrideId(long brideId) {
    this.brideId = brideId;
    setBrideIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSQueryNewlyWedsInfo)
      return this.equals((CSQueryNewlyWedsInfo)that);
    return false;
  }

  public boolean equals(CSQueryNewlyWedsInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSQueryNewlyWedsInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSQueryNewlyWedsInfo typedOther = (CSQueryNewlyWedsInfo)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSQueryNewlyWedsInfo(");
    boolean first = true;
  ...
  private static class CSQueryNewlyWedsInfoStandardSchemeFactory implements SchemeFactory {
    public CSQueryNewlyWedsInfoStandardScheme getScheme() {
      return new CSQueryNewlyWedsInfoStandardScheme();
    }
  }

  private static class CSQueryNewlyWedsInfoStandardScheme extends StandardScheme<CSQueryNewlyWedsInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSQueryNewlyWedsInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSQueryNewlyWedsInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSQueryNewlyWedsInfoTupleSchemeFactory implements SchemeFactory {
    public CSQueryNewlyWedsInfoTupleScheme getScheme() {
      return new CSQueryNewlyWedsInfoTupleScheme();
    }
  }

  private static class CSQueryNewlyWedsInfoTupleScheme extends TupleScheme<CSQueryNewlyWedsInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSQueryNewlyWedsInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSQueryNewlyWedsInfo struct) throws org.apache.thrift.TException {
