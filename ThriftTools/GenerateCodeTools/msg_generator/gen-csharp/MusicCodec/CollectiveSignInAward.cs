...
namespace MusicCodec
{
  ...
  [Serializable]
  #endif
  public partial class CollectiveSignInAward : TBase
  {
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  VipSignAward _elem14 = new VipSignAward();
                  _elem14 = new VipSignAward();
                  _elem14.Read(iprot);
                  VipAward.Add(_elem14);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CollectiveSignInAward");
      oprot.WriteStructBegin(struc);
      TField field = new TField();
      if (__isset.dayAmount) {
        field.Name = "dayAmount";
        field.Type = TType.I32;
        field.ID = 1;
        oprot.WriteFieldBegin(field);
        oprot.WriteI32(DayAmount);
        oprot.WriteFieldEnd();
      }
      ...
      if (VipAward != null && __isset.vipAward) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (VipSignAward _iter15 in VipAward)
          {
            _iter15.Write(oprot);
          }
          oprot.WriteListEnd();
