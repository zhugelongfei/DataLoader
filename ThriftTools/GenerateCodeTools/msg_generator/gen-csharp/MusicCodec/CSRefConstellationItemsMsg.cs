...
namespace MusicCodec
{
  ...
  [Serializable]
  #endif
  public partial class CSRefConstellationItemsMsg : TBase
  {
    private MusicCodec.RefreshType _type;
    private byte _constellationId;

    /// <summary>
    /// 
    /// <seealso cref="MusicCodec.RefreshType"/>
    /// </summary>
    public MusicCodec.RefreshType Type
    {
      get
      {
        return _type;
...
ClientLog.Instance.LogError("This function is deleted.");
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CSRefConstellationItemsMsg");
