...
BuildInfo::~BuildInfo() throw() {
}


void BuildInfo::__set_ID(const int32_t val) {
  this->ID = val;
}

void BuildInfo::__set_Name(const std::string& val) {
  this->Name = val;
}

void BuildInfo::__set_ResId(const int32_t val) {
  this->ResId = val;
}

void BuildInfo::__set_SizeX(const int32_t val) {
  this->SizeX = val;
}

void BuildInfo::__set_SizeY(const int32_t val) {
  this->SizeY = val;
}
...
uint32_t BuildInfo::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("SizeX", ::apache::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32(this->SizeX);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("SizeY", ::apache::thrift::protocol::T_I32, 5);
...
BuildInfo::BuildInfo(const BuildInfo& other0) {
  ID = other0.ID;
  Name = other0.Name;
  ResId = other0.ResId;
  SizeX = other0.SizeX;
...
BuildInfo& BuildInfo::operator=(const BuildInfo& other1) {
  ID = other1.ID;
  Name = other1.Name;
  ResId = other1.ResId;
  SizeX = other1.SizeX;
